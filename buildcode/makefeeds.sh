...
../buildcode/generate_query_feed.py -f ../raw_parts/feedinfo-hunting.csv -c ../raw_parts/hunting.csv -o ../feeds/DeloitteHunting -p ../pretty_feed_links/DeloitteHunting.tsv
